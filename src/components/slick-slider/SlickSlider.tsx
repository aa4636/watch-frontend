...
import StreamSphereNavigationLink from "src/components/StreamSphereNavigationLink";
...
const StyledSlider = styled(Slider)(
  ({ theme, padding }: { theme: Theme; padding: number }) => ({
    ...
    [theme.breakpoints.up("sm")]: {
      ...
      "& .slick-list > .slick-track > .slick-current > div > .StreamSphereBox-root > .StreamSpherePaper-root:hover":
        {
